...
const recoveredTotal = $<HTMLParagraphElement>('.recovered') as HTMLParagraphElement;
const lastUpdatedTime = $<HTMLParagraphElement>('.last-updated-time') as HTMLParagraphElement;
const rankList = $<HTMLOListElement>('.rank-list') as HTMLOListElement;
const deathsList = $<HTMLOListElement>('.deaths-list') as HTMLOListElement;
const recoveredList = $<HTMLOListElement>('.recovered-list') as HTMLOListElement;
